...
public class CameraPlayerRenderer extends RenderPlayer{
	
	final ResourceLocation ptexture = new ResourceLocation(RPGMod.MODID, "textures/gui/test_skin.png");	
	
	
	public CameraPlayerRenderer(RenderManager renderManager) {
		super(renderManager);
